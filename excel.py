...
_writer_extensions = ["xlsx", "xls", "xlsm","XLSX"]
_writers = {}
...
def _get_default_writer(ext):
    _default_writers = {'xlsx': 'openpyxl','XLSX': 'openpyxl', 'xlsm': 'openpyxl', 'xls': 'xlwt'}
    try:
...
class ExcelWriter(object):
    ...
    def __init__(self, path, engine=None,
        ...
        if isinstance(path, string_types):
            ...
            ext = 'xls' if engine == 'xlwt' else 'xlsx' or 'XLSX'
...
class _Openpyxl1Writer(ExcelWriter):
    engine = 'openpyxl1'
    supported_extensions = ('.xlsx', '.xlsm','.XLSX')
    openpyxl_majorver = 1
